...
<<<<<<< HEAD
        ...
        <div class="flex gap-3 action-buttons">
            ...
            <a href="{{ route('reservations.edit', $reservation->id) }}" class="flex items-center gap-2 px-4 py-2 bg-blue-600 text-white rounded-xl text-sm font-medium hover:bg-blue-700 transition-all shadow-md">
        ...
        <div class="md:col-span-2 space-y-6">
            ...
            <div class="bg-white p-6 rounded-3xl shadow-sm border border-gray-100">
                ...
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <div>
                        <p class="text-xs text-gray-500 uppercase font-bold">LicenseNumber</p>
                        <p class="text-gray-800 font-medium">{{ $reservation->client->license_number }}</p>
>>>>>>> 3194abe (Reservation amelioration)
                    </div>
                </div>
            </div>
